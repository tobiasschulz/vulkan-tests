...
private:
    ...
    void createInstance () {
        ...
        vk::ApplicationInfo appInfo ("Hello Triangle 2", VK_MAKE_VERSION(1, 0, 0), "No Engine",
    ...
    void createSwapChain () {
        ...
        QueueFamilyIndices indices = __findQueueFamilies (physicalDevice);
